        ...
        !especiales.includes(email.charAt(0))) {
            ...
            var posicionArroba = email.indexOf("@"); //devuelve la posicion del arroba
                ...
                esEmail=false;
                        ...
                        for (var i=1; i<posicionArroba -1; i++) {
                    ...
                    if ((email.charAt(posicionArroba -1) < "a" || email.charAt(posicionArroba -1)>"z") && 
                        !especiales.includes(email.charAt(posicionArroba -1)) && 
                        (email.charAt(posicionArroba -1)<"0" || email.charAt(posicionArroba -1) > "9")) {
